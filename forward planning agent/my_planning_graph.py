...
class ActionLayer(BaseActionLayer):
    ...
    def _interference(self, actionA, actionB):
        ...
        # TODO: implement this function
        for effectA in actionA.effects:
            for pre_condB in actionB.preconditions:
                if ~pre_condB == effectA:
                    return True
        for effectB in actionB.effects:
            for pre_condA in actionA.preconditions:
                if ~pre_condA == effectB:
                    return True
        return False
    ...
    def _competing_needs(self, actionA, actionB):
        ...
        for pre_condA in actionA.preconditions:
            for pre_condB in actionB.preconditions:
                if self.parent_layer.is_mutex(pre_condA,pre_condB):
                    return True
        return False
...
class LiteralLayer(BaseLiteralLayer):
    ...
    def _inconsistent_support(self, literalA, literalB):
        ...
        """
        # TODO: implement this function
        for way_a in self.parents[literalA]:
            for way_b in self.parents[literalB]:
                if self.parent_layer.is_mutex(way_a, way_b) is False:
                    return False
        return True
